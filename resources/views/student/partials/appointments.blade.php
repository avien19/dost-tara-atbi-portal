        ...
        @foreach(['John Doe', 'Jane Smith', 'Alex Johnson'] as $mentor)
            <div class="bg-white shadow rounded-lg p-4">
                ...
                <div class="flex justify-between">
                    <button class="px-4 py-2 border border-blue-500 text-blue-500 rounded hover:bg-blue-100">Reschedule</button>
                    <button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Join Meeting</button>
                </div>
            </div>
        @endforeach
    </div>
    <button class="mt-6 w-full px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Schedule New Appointment</button>
</div>
