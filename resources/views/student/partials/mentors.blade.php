<div class="bg-white shadow rounded-lg p-6">
    ...
    <div class="flex mb-6">
        <input type="text" placeholder="Search mentors by name, skill, or expertise..." class="flex-grow px-4 py-2 border border-gray-300 rounded-l-md">
        ...
        @foreach(['John Doe', 'Jane Smith', 'Alex Johnson', 'Emily Brown', 'Michael Lee', 'Sarah Wilson'] as $mentor)
            <div class="bg-white shadow rounded-lg p-4">
                ...
                <div class="flex justify-between">
                    <button class="px-4 py-2 border border-blue-500 text-blue-500 rounded hover:bg-blue-100">View Profile</button>
                    <button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Request Session</button>
                </div>
            </div>
        @endforeach
    </div>
